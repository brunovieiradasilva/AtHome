...
public class HistoricoVendasView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fundo.setIcon(new javax.swing.ImageIcon("src\\main\\java\\imagens\\telas1.png")); // NOI18N
    ...
    protected void atualizarEstoqueList(String nome) {
        DefaultListModel<Vendas> Model = (DefaultListModel<Vendas>) estoqueList.getModel();
        CRUD oi;
        try {
            oi = new CRUD();
            Model.clear();
            for (Vendas venda : oi.getTodosVendas()) {
