...
public class EstoqueView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fundo.setIcon(new javax.swing.ImageIcon("src\\main\\java\\imagens\\Estoque-page.png")); // NOI18N
        ...
        if (removeBtn.isEnabled()) {
            ...
            try {
                ...
                if (i == 0) {
                    ...
                    ((DefaultListModel<Produto>) estoqueList.getModel()).remove(estoqueList.getSelectedIndex());
                    limparLista();
    ...
    protected void atualizarEstoqueList(String nome) {
        DefaultListModel<Produto> Model = (DefaultListModel<Produto>) estoqueList.getModel();
        CRUD oi;
        try {
            oi = new CRUD();
            Model.clear();
